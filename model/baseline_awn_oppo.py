...
class AWLeNet5_oppo(AWNet):
    def __init__(self, num_classes=18,
        ...
        self.classifier = nn.Sequential(
            SliceableLinear(n*420, num_classes, fixed_out=True)  #420 360
        )
...
def get_model(args):
    ...
    return AWLeNet5_oppo(num_classes=args.num_classes,
