...
# from block.awn_full_weight import SliceableLinear
# from block.awn_full_weight import MaskTriangularConv2d
# from block.awn_full_weight import SwitchableSharedBatchNorm2d
# from block.awn_full_weight import AWNet
...
class AWLeNet5_uci(AWNet):
    def __init__(self, num_classes=6,
                 init_width_mult=1, slices=[1.0], divisor=1, min_channels=1):
